...
typedef struct StatusBar {
    ...
    /* 0x46 */ s8 alwaysShown; // when set, the status bar will always be shown. used while browsing a shop.
...
typedef struct Camera {
    ...
    /* 0x074 */ f32 curBoomLength;
    /* 0x078 */ f32 curBoomPitch;
...
typedef struct BattleStatus {
    ...
    /* 0x097 */ s8 jumpCharge;
    /* 0x098 */ b8 overcharged; // unused, inreases all damage by 2 when true
    /* 0x099 */ u8 rushFlags; // is power or mega rush active? see: RushFlags
...
typedef struct AnimatorNodeBlueprint {
    ...
    /* 0x04 */ Vec3f basePos;
    /* 0x10 */ Vec3f rot;
} AnimatorNodeBlueprint; // size = 0x1C
...
typedef struct ModelAnimator {
    ...
    /* 0x1FD */ u8 staticNodeIDs[0x7A]; // ?
    /* 0x277 */ PAD(1);
    /* 0x278 */ f32 nextUpdateTime;
    /* 0x27C */ f32 timeScale;
    /* 0x280 */ Mtx mtx;
    /* 0x2C0 */ void* baseAddr;
...
typedef struct MenuWindowBP {
    ...
    /* 0x0A */ u8 priority;
    /* 0x0B */ PAD(1);
    /* 0x0C */ MenuPanelDrawContentFunc* fpDrawContents;
    /* 0x10 */ MenuPanel* tab;
    /* 0x14 */ s8 parentID;
    /* 0x15 */ PAD(3);
...
typedef struct {
    ...
    /* 0x10 */ s16 width;
    /* 0x12 */ s16 height;
    /* 0x14 */ WindowDrawContentFunc* fpDrawContents;
