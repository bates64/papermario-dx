...
enum GameFlags {
    ...
    GF_NOK11_Item_BadgeEmblem_A                 = GameFlag(0x7FB),
    GF_NOK11_Item_BadgeEmblem_B                 = GameFlag(0x7FC),
    GF_NOK11_Item_BadgeEmblem_C                 = GameFlag(0x7FD),
    GF_NOK11_Item_BadgeEmblem_X                 = GameFlag(0x7FE),
    GF_NOK11_Item_BadgeEmblem_Y                 = GameFlag(0x7FF),
};
