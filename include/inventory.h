...
/// Recover player HP. `amt` is the amount to recover, -1 for full, or -2 for full and increase
/// max by 1 (unused). Returns the new HP value, after recovery has been applied.
