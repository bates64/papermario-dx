...
EvtScript N(EVS_MakeEntities) = {
    ...
    Call(MakeEntity, Ref(Entity_BrickBlock), 160, 108, -326, 0, MAKE_ENTITY_END)
    ...
    Call(MakeItemEntity, ITEM_MUSHROOM, 142, 0, 0, ITEM_SPAWN_MODE_KEY, 1)
    Call(MakeItemEntity, ITEM_MUSHROOM, 166, 0, 0, ITEM_SPAWN_MODE_KEY, 1)
    Return
    End
};
