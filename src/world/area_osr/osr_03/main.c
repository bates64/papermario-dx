...
EvtScript N(EVS_Main) = {
    ...
    Switch(GB_StoryProgress)
        ...
        CaseDefault
            ...
            Else
                Call(SetMusic, 0, SONG_BOWSERS_CASTLE_FALLS, 0, 8)
            EndIf
    EndSwitch
    Exec(N(EVS_EnterMap))
    Call(GetEntryID, LVar0)
