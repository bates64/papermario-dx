...
EvtScript N(EVS_ManageSneakingScenes) = {
    ...
    Thread
        Call(SetMusic, 0, SONG_PEACH_SNEAKING, 0, 8)
        Wait(3)
        Call(SetMusic, 0, SONG_PEACH_SNEAKING, 0, 7)
        Wait(3)
        Call(SetMusic, 0, SONG_PEACH_SNEAKING, 0, 6)
        Wait(3)
        Call(SetMusic, 0, SONG_PEACH_SNEAKING, 0, 5)
        Wait(3)
        Call(SetMusic, 0, SONG_PEACH_SNEAKING, 0, 4)
    EndThread
