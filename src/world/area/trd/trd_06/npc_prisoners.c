...
NpcData N(NpcData_Jailers)[] = {
    {
        ...
        .animations = {
            ...
            .alert  = ANIM_KoopaTroopa_Idle,
            .unused = ANIM_KoopaTroopa_Idle,
    ...
    },
    {
        ...
        .animations = {
            ...
            .alert  = ANIM_Bobomb_Idle,
            .unused = ANIM_Bobomb_Idle,
...
NpcData N(NpcData_Inmates)[] = {
    {
        ...
        .animations = {
            ...
            .alert  = ANIM_WorldBobomb_Red_Idle,
            .unused = ANIM_WorldBobomb_Red_Idle,
    ...
    },
    {
        ...
        .animations = {
            ...
            .alert  = ANIM_WorldBobomb_Blue_Idle,
            .unused = ANIM_WorldBobomb_Blue_Idle,
    ...
    },
    {
        ...
        .animations = {
            ...
            .alert  = ANIM_WorldBobomb_Green_Idle,
            .unused = ANIM_WorldBobomb_Green_Idle,
