...
EvtScript N(EVS_SuspiciousGuy_RevealSecretRoom) = {
    ...
    Wait(4 * DT)
    Call(SetNpcAnimation, NPC_ShyGuy_01, ANIM_ShyGuy_Pink_Run)
    Wait(4 * DT)
    Call(SetNpcAnimation, NPC_ShyGuy_01, ANIM_ShyGuy_Pink_Dash)
    Wait(4 * DT)
    Call(NpcMoveTo, NPC_ShyGuy_01, -440, 3, 50 * DT)
    Call(SetNpcAnimation, NPC_ShyGuy_01, ANIM_ShyGuy_Pink_Idle)
    Wait(8 * DT)
    ...
    Call(InterpNpcYaw, NPC_ShyGuy_01, 180, 10 * DT)
    Call(InterpNpcYaw, NPC_ShyGuy_01, 0, 10 * DT)
    Call(SpeakToPlayer, NPC_ShyGuy_01, ANIM_ShyGuy_Pink_Excited, ANIM_ShyGuy_Pink_Idle, 5, MSG_MAC_Housing_00B4)
    Wait(10 * DT)
    Call(SetNpcAnimation, NPC_ShyGuy_01, ANIM_ShyGuy_Pink_Neutral)
    Wait(4 * DT)
...
EvtScript N(EVS_SuspiciousGuy_RunAway) = {
    ...
    Wait(20 * DT)
    Call(SpeakToPlayer, NPC_ShyGuy_01, ANIM_ShyGuy_Pink_Excited, ANIM_ShyGuy_Pink_Idle, 0, MSG_MAC_Housing_00B2)
...
EvtScript N(EVS_OnEnterShop) = {
    ...
    Call(SetNpcAnimation, NPC_ShyGuy_02, ANIM_ShyGuy_Red_Dash)
    Call(DisablePlayerInput, true)
    Wait(30)
