...
#endif
    Set(AF_MAC03_Unread_20, false)
    Set(AF_MAC03_Unread_21, false)
    Set(AF_MAC03_Unread_22, false)
    Set(AF_MAC03_Unread_23, false)
    Set(AF_MAC03_Unread_24, false)
    Set(AF_MAC03_Unread_25, false)
