...
EvtScript N(EVS_ExitDoor_dgb_04_1) = EVT_EXIT_SINGLE_DOOR_SET_SOUNDS(
    dgb_06_ENTRY_0, "dgb_04", dgb_04_ENTRY_1, COLLIDER_deilittw, MODEL_o161, DOOR_SWING_IN, DOOR_SOUNDS_BASIC
);
