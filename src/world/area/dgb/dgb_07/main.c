...
EvtScript N(EVS_ExitDoor_dgb_02_2) = EVT_EXIT_SINGLE_DOOR_SET_SOUNDS(
    dgb_07_ENTRY_0, "dgb_02", dgb_02_ENTRY_2, COLLIDER_deilits, MODEL_o158, DOOR_SWING_IN, DOOR_SOUNDS_BASIC
);
