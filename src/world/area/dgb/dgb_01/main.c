...
EvtScript N(EVS_ExitDoors_dgb_00_1) = EVT_EXIT_DOUBLE_DOOR_SET_SOUNDS(
    dgb_01_ENTRY_0, "dgb_00", dgb_00_ENTRY_1, COLLIDER_deilitts, MODEL_o380, MODEL_o381, DOOR_SOUNDS_CREAKY
);

EvtScript N(EVS_ExitDoors_dgb_02_1) = EVT_EXIT_DOUBLE_DOOR_SET_SOUNDS(
    dgb_01_ENTRY_1, "dgb_02", dgb_02_ENTRY_1, COLLIDER_deilittsw, MODEL_o163, MODEL_o164, DOOR_SOUNDS_CREAKY
);

EvtScript N(EVS_ExitDoors_dgb_08_0) = EVT_EXIT_DOUBLE_DOOR_SET_SOUNDS(
    dgb_01_ENTRY_2, "dgb_08", dgb_08_ENTRY_0, COLLIDER_deilittse, MODEL_o168, MODEL_o167, DOOR_SOUNDS_CREAKY
);

EvtScript N(EVS_ExitDoors_dgb_09_1) = EVT_EXIT_DOUBLE_DOOR_SET_SOUNDS(
    dgb_01_ENTRY_3, "dgb_09", dgb_09_ENTRY_1, COLLIDER_deilittw, MODEL_o165, MODEL_o166, DOOR_SOUNDS_CREAKY
);

EvtScript N(EVS_ExitDoors_dgb_08_1) = EVT_EXIT_DOUBLE_DOOR_SET_SOUNDS(
    dgb_01_ENTRY_4, "dgb_08", dgb_08_ENTRY_1, COLLIDER_deilitte, MODEL_o299, MODEL_o298, DOOR_SOUNDS_CREAKY
);

EvtScript N(EVS_ExitDoors_dgb_17_1) = EVT_EXIT_DOUBLE_DOOR_SET_SOUNDS(
    dgb_01_ENTRY_5, "dgb_17", dgb_17_ENTRY_1, COLLIDER_deilittnw, MODEL_o161, MODEL_o162, DOOR_SOUNDS_CREAKY
);

EvtScript N(EVS_ExitDoors_dgb_18_0) = EVT_EXIT_DOUBLE_DOOR_SET_SOUNDS(
    dgb_01_ENTRY_6, "dgb_18", dgb_18_ENTRY_0, COLLIDER_deilittne, MODEL_o301, MODEL_o300, DOOR_SOUNDS_CREAKY
);
