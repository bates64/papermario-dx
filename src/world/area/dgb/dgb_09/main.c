...
EvtScript N(exitDoubleDoor_80243920) = EVT_EXIT_DOUBLE_DOOR_SET_SOUNDS(
    dgb_09_ENTRY_0, "dgb_03", dgb_03_ENTRY_4, COLLIDER_deilittw, MODEL_o30, MODEL_o31, DOOR_SOUNDS_CREAKY
);

EvtScript N(exitDoubleDoor_802439D4) = EVT_EXIT_DOUBLE_DOOR_SET_SOUNDS(
    dgb_09_ENTRY_1, "dgb_01", dgb_01_ENTRY_3, COLLIDER_deilitte, MODEL_o102, MODEL_o101, DOOR_SOUNDS_CREAKY
);

EvtScript N(exitSingleDoor_80243A88) = EVT_EXIT_SINGLE_DOOR_SET_SOUNDS(
    dgb_09_ENTRY_2, "dgb_12", dgb_12_ENTRY_0, COLLIDER_deilittnw, MODEL_o76, DOOR_SWING_OUT, DOOR_SOUNDS_BASIC
);
