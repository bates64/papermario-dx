...
EvtScript N(EVS_GetApproachPeachPos) = {
    ...
    Thread
        ...
        Sub(LVar0, 26)
        Sub(LVar2, 2)
        Call(SetNpcAnimation, NPC_HammerBros, ANIM_HammerBros_Run)
        Call(SetNpcSpeed, NPC_HammerBros, Float(5.0))
        Call(NpcMoveTo, NPC_HammerBros, LVar0, LVar2, 0)
        Call(SetNpcAnimation, NPC_HammerBros, ANIM_HammerBros_Idle)
...
EvtScript N(EVS_ManageSneakingScenes) = {
    ...
    EndThread
    Call(SpeakToNpc, NPC_HammerBros, ANIM_HammerBros_Talk, ANIM_HammerBros_Idle, 0, NPC_Koopatrol_01, MSG_Peach_006E)
    Call(SpeakToNpc, NPC_Koopatrol_01, ANIM_WorldKoopatrol_Talk, ANIM_WorldKoopatrol_Idle, 0, NPC_HammerBros, MSG_Peach_006F)
    Call(SpeakToNpc, NPC_HammerBros, ANIM_HammerBros_Talk, ANIM_HammerBros_Idle, 0, NPC_Koopatrol_01, MSG_Peach_0070)
    Call(SpeakToNpc, NPC_Koopatrol_01, ANIM_WorldKoopatrol_Talk, ANIM_WorldKoopatrol_Idle, 0, NPC_HammerBros, MSG_Peach_0071)
    Call(SpeakToNpc, NPC_HammerBros, ANIM_HammerBros_Talk, ANIM_HammerBros_Idle, 0, NPC_Koopatrol_01, MSG_Peach_0072)
    Call(SpeakToNpc, NPC_Koopatrol_01, ANIM_WorldKoopatrol_Talk, ANIM_WorldKoopatrol_Idle, 0, NPC_HammerBros, MSG_Peach_0073)
    Call(SpeakToNpc, NPC_HammerBros, ANIM_HammerBros_Talk, ANIM_HammerBros_Idle, 0, NPC_Koopatrol_01, MSG_Peach_0074)
    Call(SpeakToNpc, NPC_Koopatrol_01, ANIM_WorldKoopatrol_Talk, ANIM_WorldKoopatrol_Idle, 0, NPC_HammerBros, MSG_Peach_0075)
    Call(SpeakToNpc, NPC_HammerBros, ANIM_HammerBros_Talk, ANIM_HammerBros_Idle, 0, NPC_Koopatrol_01, MSG_Peach_0076)
    Call(GetPlayerPos, LVar0, LVar1, LVar2)
    ...
    Call(SpeakToNpc, NPC_HammerBros, ANIM_HammerBros_Talk, ANIM_HammerBros_Idle, 0, NPC_Koopatrol_01, MSG_Peach_0079)
    Call(SpeakToNpc, NPC_Koopatrol_01, ANIM_WorldKoopatrol_Talk, ANIM_WorldKoopatrol_Idle, 0, NPC_HammerBros, MSG_Peach_007A)
    Thread
        Call(SetNpcAnimation, NPC_HammerBros, ANIM_HammerBros_Run)
