...
EvtScript N(EVS_WaitForBuzzIn) = {
    ...
    Switch(AB_KKJ29_AnsweringContestant)
        CaseEq(CONTESTANT_LEFT)
            ...
            Call(EndSpeech, NPC_HammerBros, ANIM_HammerBros_TalkDisarmed, ANIM_HammerBros_IdleDisarmed, 5)
            Call(SpeakToPlayer, NPC_HammerBros, ANIM_HammerBros_TalkDisarmed, ANIM_HammerBros_IdleDisarmed, 5, MSG_Peach_00FA)
            Call(GetNpcPos, NPC_Koopatrol_01, LVar0, LVar1, LVar2)
        CaseEq(CONTESTANT_PEACH)
            Call(PlaySoundAtPlayer, SOUND_QUIZ_BUZZER, SOUND_SPACE_DEFAULT)
            Call(EndSpeech, NPC_HammerBros, ANIM_HammerBros_TalkDisarmed, ANIM_HammerBros_IdleDisarmed, 5)
            Call(SpeakToPlayer, NPC_HammerBros, ANIM_HammerBros_TalkDisarmed, ANIM_HammerBros_IdleDisarmed, 5, MSG_Peach_00F9)
            Call(GetPlayerPos, LVar0, LVar1, LVar2)
        CaseEq(CONTESTANT_RIGHT)
            Call(PlaySoundAtNpc, NPC_Koopatrol_02, SOUND_QUIZ_BUZZER, SOUND_SPACE_DEFAULT)
            Call(EndSpeech, NPC_HammerBros, ANIM_HammerBros_TalkDisarmed, ANIM_HammerBros_IdleDisarmed, 5)
            Call(SpeakToPlayer, NPC_HammerBros, ANIM_HammerBros_TalkDisarmed, ANIM_HammerBros_IdleDisarmed, 5, MSG_Peach_00FB)
...
EvtScript N(EVS_DeclareWinner) = {
    ...
    Switch(LVar0)
        ...
        CaseEq(OUTCOME_TIE)
            ...
            Set(LVar2, -230)
    EndSwitch
    Call(SetNpcAnimation, NPC_HammerBros, ANIM_HammerBros_WalkDisarmed)
    ...
    EndIf
    Call(SetNpcAnimation, NPC_HammerBros, ANIM_HammerBros_IdleDisarmed)
    ...
    Switch(LVar0)
        CaseEq(OUTCOME_LEFT_WON)
            Call(SpeakToNpc, NPC_HammerBros, ANIM_HammerBros_TalkDisarmed, ANIM_HammerBros_IdleDisarmed, 0, NPC_Koopatrol_01, MSG_Peach_011B)
            Call(PlaySound, SOUND_AUDIENCE_CHEER)
            Call(SetNpcAnimation, NPC_Koopatrol_01, ANIM_WorldKoopatrol_CheerForward)
            Call(ContinueSpeech, NPC_HammerBros, ANIM_HammerBros_TalkDisarmed, ANIM_HammerBros_IdleDisarmed, 5, MSG_Peach_011C)
            Wait(10)
        ...
        CaseEq(OUTCOME_PEACH_WON)
            ...
            Wait(1)
            Call(ContinueSpeech, NPC_HammerBros, ANIM_HammerBros_TalkDisarmed, ANIM_HammerBros_IdleDisarmed, 0, MSG_Peach_0122)
            Wait(10)
            Call(ShowGotItem, ITEM_JAMMIN_JELLY, true, ITEM_PICKUP_FLAG_NO_ANIMS)
            Set(GF_KKJ29_PeachWonJamminJelly, true)
            Wait(10)
        CaseEq(OUTCOME_RIGHT_WON)
            Call(SpeakToNpc, NPC_HammerBros, ANIM_HammerBros_TalkDisarmed, ANIM_HammerBros_IdleDisarmed, 0, NPC_Koopatrol_02, MSG_Peach_011E)
            Call(PlaySound, SOUND_AUDIENCE_CHEER)
            Call(SetNpcAnimation, NPC_Koopatrol_02, ANIM_WorldKoopatrol_CheerForward)
            Call(ContinueSpeech, NPC_HammerBros, ANIM_HammerBros_TalkDisarmed, ANIM_HammerBros_IdleDisarmed, 5, MSG_Peach_011F)
            Wait(10)
            Set(LVar0, ITEM_JAMMIN_JELLY)
        ...
        CaseEq(OUTCOME_TIE)
            IfEq(AB_KKJ29_PeachScore, 0)
                Call(SpeakToPlayer, NPC_HammerBros, ANIM_HammerBros_TalkDisarmed, ANIM_HammerBros_IdleDisarmed, 5, MSG_Peach_0124)
            Else
                Call(SpeakToPlayer, NPC_HammerBros, ANIM_HammerBros_TalkDisarmed, ANIM_HammerBros_IdleDisarmed, 5, MSG_Peach_0123)
            EndIf
            Call(PlaySound, SOUND_AUDIENCE_BOO)
    EndSwitch
    Return
...
EvtScript N(EVS_GetApproachPeachPos) = {
    ...
    Thread
        ...
        Sub(LVar0, 26)
        Sub(LVar2, 2)
        Call(SetNpcAnimation, NPC_HammerBros, ANIM_HammerBros_RunDisarmed)
...
EvtScript N(EVS_PickUpPeach) = {
    Thread
        ...
        Call(SetNpcAnimation, NPC_HammerBros, ANIM_HammerBros_Lift)
        Add(LVar0, 5)
        Call(NpcMoveTo, NPC_HammerBros, LVar0, LVar2, 5)
    EndThread
    Thread
...
EvtScript N(EVS_CarryPeachAway) = {
    ...
    Call(SetNpcVar, NPC_HammerBros, 0, 1)
    Thread
        Call(SetNpcAnimation, NPC_HammerBros, ANIM_HammerBros_CarryFast)
        Call(SetNpcSpeed, NPC_HammerBros, Float(5.0))
...
EvtScript N(EVS_ManageQuizGame) = {
    ...
    Call(PanToTarget, CAM_DEFAULT, 0, true)
    Call(WaitForCam, CAM_DEFAULT, Float(1.0))
    Call(SpeakToNpc, NPC_HammerBros, ANIM_HammerBros_TalkDisarmed, ANIM_HammerBros_IdleDisarmed, 0, NPC_Koopatrol_01, MSG_Peach_00F0)
    ...
    Call(SetNpcAnimation, NPC_HammerBros, ANIM_HammerBros_IdleDisarmed)
    Call(SpeakToPlayer, NPC_HammerBros, ANIM_HammerBros_TalkDisarmed, ANIM_HammerBros_IdleDisarmed, 0, MSG_Peach_00F2)
    Call(InterpNpcYaw, NPC_Koopatrol_01, 90, 5)
    Call(GetPlayerPos, LVar0, LVar1, LVar2)
    Sub(LVar0, 40)
    ...
    Call(SpeakToPlayer, NPC_HammerBros, ANIM_HammerBros_TalkDisarmed, ANIM_HammerBros_IdleDisarmed, 5, MSG_Peach_00F5)
    Call(PlaySound, SOUND_AUDIENCE_CHEER)
    Wait(10 * DT)
    Call(SpeakToPlayer, NPC_HammerBros, ANIM_HammerBros_TalkDisarmed, ANIM_HammerBros_IdleDisarmed, 5, MSG_Peach_00F6)
    Call(PlaySound, SOUND_AUDIENCE_CHEER)
    ...
    Call(SpeakToPlayer, NPC_HammerBros, ANIM_HammerBros_TalkDisarmed, ANIM_HammerBros_IdleDisarmed, 0, MSG_Peach_0125)
    Call(SetNpcVar, NPC_HammerBros, 0, 1)
    Thread
        Wait(20 * DT)
    ...
    Call(SpeakToPlayer, NPC_HammerBros, ANIM_HammerBros_TalkDisarmed, ANIM_HammerBros_IdleDisarmed, 0, MSG_Peach_0126)
    Call(ShowGotItem, ITEM_SNEAKY_PARASOL, true, 0)
    Call(SpeakToPlayer, NPC_HammerBros, ANIM_HammerBros_TalkDisarmed, ANIM_HammerBros_IdleDisarmed, 0, MSG_Peach_0127)
    Wait(10 * DT)
    ...
    Loop(2)
        ...
        Call(SetNpcAnimation, NPC_Bowser, ANIM_WorldBowser_Idle)
        Wait(3 * DT)
        Call(SetNpcAnimation, NPC_HammerBros, ANIM_HammerBros_TalkDisarmed)
        Wait(10 * DT)
        Call(SetNpcAnimation, NPC_HammerBros, ANIM_HammerBros_IdleDisarmed)
        Wait(3 * DT)
    EndLoop
