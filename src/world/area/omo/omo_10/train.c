...
EvtScript N(D_80243AF8_DDB4A8) = {
    ...
    Set(MV_TrainPath, Ref(N(D_80243AC8_DDB478)))
...
EvtScript N(D_80243CA0_DDB650) = {
    ...
    Call(ModifyColliderFlags, MODIFY_COLLIDER_FLAGS_SET_BITS, COLLIDER_o961, COLLIDER_FLAGS_UPPER_MASK)
    Set(MV_TrainRideState, 0)
    Set(MV_TrainPath, Ref(N(D_80243C68_DDB618)))
    Set(MV_TrainUnk_02, 1)
    Set(MF_TrainRideActive, true)
    Label(10)
...
EvtScript N(D_80243E98_DDB848) = {
    ...
    IfEq(AB_OMO_6, 3)
        Set(MV_TrainRideState, 0)
        Set(MV_TrainPath, Ref(N(D_80243E10_DDB7C0)))
    ...
    Else
        ...
        Set(MV_TrainRideState, 0)
        Set(MV_TrainPath, Ref(N(D_80243E48_DDB7F8)))
...
EvtScript N(D_802441D0_DDBB80) = {
    ...
    IfEq(AB_OMO_6, 3)
        Set(MV_TrainRideState, 0)
        Set(MV_TrainPath, Ref(N(D_80244150_DDBB00)))
        Set(MV_TrainUnk_02, 2)
        Exec(N(EVS_Scene_RideTrain))
        Set(MF_TrainRideActive, true)
        Wait(1)
    ...
    Else
        Exec(N(EVS_TrainUnk_A))
        Set(MV_TrainRideState, 0)
        Set(MV_TrainPath, Ref(N(D_80244188_DDBB38)))
        Set(MV_TrainUnk_02, 0)
        Exec(N(EVS_Scene_RideTrain))
        Set(MF_TrainRideActive, true)
        Wait(1)
...
EvtScript N(EVS_SetupTrain) = {
    ...
    IfEq(LVar1, 1)
        Set(MV_TrainRideState, 0)
        Set(MV_TrainPath, Ref(N(D_802446B8_DDC068)))
        Set(MV_TrainUnk_02, 0)
        Exec(N(EVS_Scene_RideTrain))
        Set(MF_TrainRideActive, true)
    Else
