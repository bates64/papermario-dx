...
EvtScript N(D_80246778_DCAB48) = {
    ...
    Set(MV_TrainPath, Ref(N(D_80246748_DCAB18)))
...
EvtScript N(D_80246918_DCACE8) = {
    ...
    Call(ModifyColliderFlags, MODIFY_COLLIDER_FLAGS_SET_BITS, COLLIDER_o1074, COLLIDER_FLAGS_UPPER_MASK)
    Set(MV_TrainRideState, 0)
    Set(MV_TrainPath, Ref(N(D_802468E8_DCACB8)))
    Set(MV_TrainUnk_02, 1)
    Set(MF_TrainRideActive, true)
    Label(10)
...
EvtScript N(D_80246B08_DCAED8) = {
    ...
    IfEq(AB_OMO_6, 2)
        Set(MV_TrainRideState, 0)
        Set(MV_TrainPath, Ref(N(D_80246A88_DCAE58)))
    ...
    Else
        ...
        Set(MV_TrainRideState, 0)
        Set(MV_TrainPath, Ref(N(D_80246AC0_DCAE90)))
...
EvtScript N(D_80246E30_DCB200) = {
    ...
    IfEq(AB_OMO_6, 2)
        Set(MV_TrainRideState, 0)
        Set(MV_TrainPath, Ref(N(D_80246DC0_DCB190)))
        Set(MV_TrainUnk_02, 2)
        Exec(N(EVS_Scene_RideTrain))
        Set(MF_TrainRideActive, true)
        Wait(1)
    ...
    Else
        Exec(N(EVS_TrainUnk_A))
        Set(MV_TrainRideState, 0)
        Set(MV_TrainPath, Ref(N(D_80246DF0_DCB1C0)))
        Set(MV_TrainUnk_02, 0)
        Exec(N(EVS_Scene_RideTrain))
        Set(MF_TrainRideActive, true)
        Wait(1)
...
EvtScript N(EVS_SetupTrain) = {
    ...
    IfEq(LVar1, LOAD_FROM_FILE_SELECT)
        Set(MV_TrainRideState, 0)
        Set(MV_TrainPath, Ref(N(D_80247438_DCB808)))
        Set(MV_TrainUnk_02, 0)
        Exec(N(EVS_Scene_RideTrain))
        Set(MF_TrainRideActive, true)
    Else
