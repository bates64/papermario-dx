...
NpcData N(NpcData_Yoshis)[] = {
    {
        ...
        .settings = &N(NpcSettings_Yoshi_Idle),
    ...
    },
    {
        ...
        .settings = &N(NpcSettings_YoshiKid_Idle),
        .flags = COMMON_PASSIVE_FLAGS | ENEMY_FLAG_NO_SHADOW_RAYCAST,
        .drops = NO_DROPS,
...
NpcData N(NpcData_Penguins)[] = {
    {
        ...
        .settings = &N(NpcSettings_Penguin_Idle),
        .flags = COMMON_PASSIVE_FLAGS | ENEMY_FLAG_NO_SHADOW_RAYCAST,
        .drops = NO_DROPS,
...
NpcData N(NpcData_Mousers)[] = {
    {
        ...
        .settings = &N(NpcSettings_Mouser_Idle),
        .flags = COMMON_PASSIVE_FLAGS | ENEMY_FLAG_NO_SHADOW_RAYCAST,
        .drops = NO_DROPS,
...
NpcData N(NpcData_Boos)[] = {
    {
        ...
        .settings = &N(NpcSettings_Boo_Idle),
