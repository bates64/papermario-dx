...
ITEM_LIST(
    N(FoodItemList), ITEM_FRIED_SHROOM, ITEM_SPICY_SOUP, ITEM_NUTTY_CAKE, ITEM_KOOPA_TEA, ITEM_SPAGHETTI, ITEM_BIG_COOKIE,
    ITEM_CAKE, ITEM_FRIED_EGG, ITEM_BOILED_EGG, ITEM_FROZEN_FRIES, ITEM_POTATO_SALAD, ITEM_HOT_SHROOM, ITEM_BLAND_MEAL,
    ITEM_HONEY_SHROOM, ITEM_MAPLE_SHROOM, ITEM_JELLY_SHROOM, ITEM_SHROOM_CAKE, ITEM_SHROOM_STEAK, ITEM_HONEY_SUPER,
    ITEM_MAPLE_SUPER, ITEM_JELLY_SUPER, ITEM_YUMMY_MEAL, ITEM_HONEY_ULTRA, ITEM_MAPLE_ULTRA, ITEM_JELLY_ULTRA,
    ITEM_SWEET_SHROOM, ITEM_ELECTRO_POP, ITEM_FIRE_POP, ITEM_SPECIAL_SHAKE, ITEM_COCO_POP, ITEM_LIME_CANDY,
    ITEM_LEMON_CANDY, ITEM_HONEY_CANDY, ITEM_JELLY_POP, ITEM_APPLE_PIE, ITEM_KOOPASTA, ITEM_KOOKY_COOKIE,
    ITEM_YOSHI_COOKIE
);
