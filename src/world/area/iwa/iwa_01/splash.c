...
INCLUDE_IMG("world/area/iwa/iwa_01/splash.png", iwa_01_splash_img);
#include "world/area/iwa/iwa_01/splash.vtx.inc.c"
#include "world/area/iwa/iwa_01/splash.gfx.inc.c"
...
void N(gfx_build_splashes)(s32 index) {
    ...
    for (i = 0; i < NUM_SPLASHES; i++, splash++) {
        ...
        guPosition(
            &gDisplayContext->matrixStack[gMatrixListPos], splash->rot.x, splash->rot.y, splash->rot.z, splash->scale,
