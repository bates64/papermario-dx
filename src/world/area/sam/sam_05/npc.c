...
INCLUDE_IMG("world/area/sam/sam_05/monstar_blank2.png", D_80242B70);
INCLUDE_IMG("world/area/sam/sam_05/monstar_blank3.png", D_80242D70);
...
NpcData N(NpcData_Monstar) = {
    ...
    .settings = &N(NpcSettings_Monstar_Idle),
...
NpcData N(NpcData_StarKids)[] = {
    {
        ...
        .settings = &N(NpcSettings_Twink_Idle),
