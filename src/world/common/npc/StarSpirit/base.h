...
{ \
    ...
    .alert  = ANIM_WorldEldstar_Idle, \
    .unused = ANIM_WorldEldstar_Idle, \
...
{ \
    ...
    .alert  = ANIM_WorldMamar_Idle, \
    .unused = ANIM_WorldMamar_Idle, \
...
{ \
    ...
    .alert  = ANIM_WorldMuskular_Idle, \
    .unused = ANIM_WorldMuskular_Idle, \
...
{ \
    ...
    .alert  = ANIM_WorldMisstar_Idle, \
    .unused = ANIM_WorldMisstar_Idle, \
...
{ \
    ...
    .alert  = ANIM_WorldKlevar_Idle, \
    .unused = ANIM_WorldKlevar_Idle, \
...
{ \
    ...
    .alert  = ANIM_WorldKalmar_Idle, \
    .unused = ANIM_WorldKalmar_Idle, \
