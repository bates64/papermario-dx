...
{ \
    ...
    .alert  = ANIM_TrainToad_Idle, \
    .unused = ANIM_TrainToad_Idle, \
...
{ \
    ...
    .alert  = ANIM_TrainToad_Pink_Idle, \
    .unused = ANIM_TrainToad_Pink_Idle, \
...
{ \
    ...
    .alert  = ANIM_TrainToad_Blue_Idle, \
    .unused = ANIM_TrainToad_Blue_Idle, \
...
{ \
    ...
    .alert  = ANIM_TrainToad_Green_Idle, \
    .unused = ANIM_TrainToad_Green_Idle, \
...
{ \
    ...
    .alert  = ANIM_TrainToad_Red_Idle, \
    .unused = ANIM_TrainToad_Red_Idle, \
...
{ \
    ...
    .alert  = ANIM_TrainToad_White_Idle, \
    .unused = ANIM_TrainToad_White_Idle, \
