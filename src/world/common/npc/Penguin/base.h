...
{ \
    ...
    .alert  = ANIM_Penguin_Idle, \
    .unused = ANIM_Penguin_Idle, \
...
{ \
    ...
    .alert  = ANIM_MayorPenguin_Idle, \
    .unused = ANIM_MayorPenguin_Idle, \
...
{ \
    ...
    .alert  = ANIM_MayorPenguinWife_Idle, \
    .unused = ANIM_MayorPenguinWife_Idle, \
...
{ \
    ...
    .alert  = ANIM_PenguinPatrol_Idle, \
    .unused = ANIM_PenguinPatrol_Idle, \
...
{ \
    ...
    .alert  = ANIM_Herringway_Idle, \
    .unused = ANIM_Herringway_Idle, \
