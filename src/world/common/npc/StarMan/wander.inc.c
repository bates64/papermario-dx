...
MobileAISettings N(AISettings_StarMan_Wander) = {
    .moveSpeed = 1.2f,
    .moveTime = 60,
    .waitTime = 30,
...
EvtScript N(EVS_NpcAI_StarMan_Wander) = {
    ...
    Call(N(FlyingAI_Main), Ref(N(AISettings_StarMan_Wander)))
    Return
    End
};
...
NpcSettings N(NpcSettings_StarMan_Wander) = {
    ...
    .doAI = &N(EVS_NpcAI_StarMan_Wander),
};
