...
{ \
    ...
    .alert  = ANIM_Yoshi_Green_Idle, \
    .unused = ANIM_Yoshi_Green_Idle, \
...
{ \
    ...
    .alert  = ANIM_Yoshi_Blue_Idle, \
    .unused = ANIM_Yoshi_Blue_Idle, \
...
{ \
    ...
    .alert  = ANIM_Yoshi_Purple_Idle, \
    .unused = ANIM_Yoshi_Purple_Idle, \
...
{ \
    ...
    .alert  = ANIM_Yoshi_Yellow_Idle, \
    .unused = ANIM_Yoshi_Yellow_Idle, \
...
{ \
    ...
    .alert  = ANIM_Yoshi_Red_Idle, \
    .unused = ANIM_Yoshi_Red_Idle, \
...
{ \
    ...
    .alert  = ANIM_VillageLeader_Idle, \
    .unused = ANIM_VillageLeader_Idle, \
...
{ \
    ...
    .alert  = ANIM_LeadersFriend_Idle, \
    .unused = ANIM_LeadersFriend_Idle, \
