...
{ \
    ...
    .alert  = ANIM_Dryite_Green_Idle, \
    .unused = ANIM_Dryite_Green_Idle, \
...
{ \
    ...
    .alert  = ANIM_Dryite_Brown_Idle, \
    .unused = ANIM_Dryite_Brown_Idle, \
...
{ \
    ...
    .alert  = ANIM_Dryite_Blue_Idle, \
    .unused = ANIM_Dryite_Blue_Idle, \
...
{ \
    ...
    .alert  = ANIM_Dryite_Yellow_Idle, \
    .unused = ANIM_Dryite_Yellow_Idle, \
