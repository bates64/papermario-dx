...
{ \
    ...
    .alert  = ANIM_Toadette_Orange_Idle, \
    .unused = ANIM_Toadette_Orange_Idle, \
...
{ \
    ...
    .alert  = ANIM_Toadette_Pink_Idle, \
    .unused = ANIM_Toadette_Pink_Idle, \
...
{ \
    ...
    .alert  = ANIM_Toadette_Green_Idle, \
    .unused = ANIM_Toadette_Green_Idle, \
...
{ \
    ...
    .alert  = ANIM_Toadette_Purple_Idle, \
    .unused = ANIM_Toadette_Purple_Idle, \
