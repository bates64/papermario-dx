...
{ \
    ...
    .alert  = ANIM_YoshiKid_Green_Idle, \
    .unused = ANIM_YoshiKid_Green_Idle, \
...
{ \
    ...
    .alert  = ANIM_YoshiKid_Blue_Idle, \
    .unused = ANIM_YoshiKid_Blue_Idle, \
...
{ \
    ...
    .alert  = ANIM_YoshiKid_Purple_Idle, \
    .unused = ANIM_YoshiKid_Purple_Idle, \
...
{ \
    ...
    .alert  = ANIM_YoshiKid_Yellow_Idle, \
    .unused = ANIM_YoshiKid_Yellow_Idle, \
...
{ \
    ...
    .alert  = ANIM_YoshiKid_Red_Idle, \
    .unused = ANIM_YoshiKid_Red_Idle, \
