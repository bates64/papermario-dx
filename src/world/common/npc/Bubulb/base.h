...
{ \
    ...
    .alert  = ANIM_Bubulb_Pink_Idle, \
    .unused = ANIM_Bubulb_Pink_Idle, \
...
{ \
    ...
    .alert  = ANIM_Bubulb_Purple_Idle, \
    .unused = ANIM_Bubulb_Purple_Idle, \
...
{ \
    ...
    .alert  = ANIM_Bubulb_Green_Idle, \
    .unused = ANIM_Bubulb_Green_Idle, \
...
{ \
    ...
    .alert  = ANIM_Bubulb_Yellow_Idle, \
    .unused = ANIM_Bubulb_Yellow_Idle, \
