...
MobileAISettings N(AISettings_Ember_Wander) = {
    .moveSpeed = 0.8f,
    .moveTime = 100,
    .alertRadius = 90.0f,
...
EvtScript N(EVS_NpcAI_Ember_Wander) = {
    ...
    Call(N(FlyingNoAttackAI_Main), Ref(N(AISettings_Ember_Wander)))
    Return
    End
};

NpcSettings N(NpcSettings_Ember_Wander) = {
    .height = 20,
    .radius = 22,
    .level = ACTOR_LEVEL_EMBER,
    .doAI = &N(EVS_NpcAI_Ember_Wander),
    .onHit = &EnemyNpcHit,
