...
MobileAISettings N(AISettings_RuffPuff_Wander) = {
    .moveSpeed = 1.0f,
    .moveTime = 45,
    .waitTime = 60,
    .alertRadius = 100.0f,
...
EvtScript N(EVS_NpcAI_RuffPuff_Wander) = {
    ...
    Call(N(FlyingNoAttackAI_Main), Ref(N(AISettings_RuffPuff_Wander)))
    Return
    End
};

NpcSettings N(NpcSettings_RuffPuff_Wander) = {
    .height = 24,
    .radius = 28,
    .level = ACTOR_LEVEL_RUFF_PUFF,
    .doAI = &N(EVS_NpcAI_RuffPuff_Wander),
    .onHit = &EnemyNpcHit,
