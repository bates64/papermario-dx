...
{ \
    ...
    .alert  = ANIM_BuzzyBeetle_Still, \
    .unused = ANIM_BuzzyBeetle_Still, \
...
{ \
    ...
    .alert  = ANIM_SpikeTop_Idle, \
    .unused = ANIM_SpikeTop_Idle, \
...
{ \
    ...
    .alert  = ANIM_BonyBeetle_Idle, \
    .unused = ANIM_BonyBeetle_Idle, \
