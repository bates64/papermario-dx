...
MobileAISettings N(AISettings_LavaBubble_Wander) = {
    .moveSpeed = 0.8f,
    .moveTime = 100,
    .alertRadius = 90.0f,
...
EvtScript N(EVS_NpcAI_LavaBubble_Wander) = {
    ...
    Call(N(FlyingNoAttackAI_Main), Ref(N(AISettings_LavaBubble_Wander)))
    Return
    End
};

NpcSettings N(NpcSettings_LavaBubble_Wander) = {
    .height = 20,
    .radius = 22,
    .level = ACTOR_LEVEL_LAVA_BUBBLE,
    .doAI = &N(EVS_NpcAI_LavaBubble_Wander),
    .onHit = &EnemyNpcHit,
