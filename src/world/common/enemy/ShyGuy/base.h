...
{ \
    ...
    .alert  = ANIM_ShyGuy_Red_Idle, \
    .unused = ANIM_ShyGuy_Red_Idle, \
...
{ \
    ...
    .alert  = ANIM_ShyGuy_Blue_Idle, \
    .unused = ANIM_ShyGuy_Blue_Idle, \
...
{ \
    ...
    .alert  = ANIM_ShyGuy_Green_Idle, \
    .unused = ANIM_ShyGuy_Green_Idle, \
...
{ \
    ...
    .alert  = ANIM_ShyGuy_Pink_Idle, \
    .unused = ANIM_ShyGuy_Pink_Idle, \
...
{ \
    ...
    .alert  = ANIM_ShyGuy_Yellow_Idle, \
    .unused = ANIM_ShyGuy_Yellow_Idle, \
...
{ \
    ...
    .alert  = ANIM_ShyGuy_Black_Idle, \
    .unused = ANIM_ShyGuy_Black_Idle, \
