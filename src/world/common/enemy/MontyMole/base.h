...
{ \
    ...
    .alert  = ANIM_MontyMole_Stand, \
    .unused = ANIM_MontyMole_Stand, \
...
{ \
    ...
    .run    = ANIM_MontyMole_Run, \
    .chase  = ANIM_MontyMole_Run, \
    .alert  = ANIM_MontyMole_Idle, \
    .unused = ANIM_MontyMole_Idle, \
...
{ \
    ...
    .alert  = ANIM_MontyMole_Dark_Idle, \
    .unused = ANIM_MontyMole_Dark_Idle, \
