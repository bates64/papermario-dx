...
MobileAISettings N(AISettings_SpyGuy_Wander) = {
    .moveSpeed = 1.5f,
    .moveTime = 60,
    .waitTime = 15,
    .alertRadius = 90.0f,
...
EvtScript N(EVS_NpcAI_SpyGuy_Wander) = {
    ...
    Call(N(RangedAttackAI_Main), Ref(N(AISettings_SpyGuy_Wander)))
    Return
    End
};

NpcSettings N(NpcSettings_SpyGuy_Wander) = {
    .height = 24,
    .radius = 22,
    .level = ACTOR_LEVEL_SPY_GUY,
    .doAI = &N(EVS_NpcAI_SpyGuy_Wander),
    .onHit = &EnemyNpcHit,
