...
EvtScript N(EVS_NpcAI_Sentinel) = {
    ...
    Call(func_80045838, NPC_SELF, SOUND_SENTINEL_PICKUP, SOUND_SPACE_DEFAULT)
    Call(SetNpcAnimation, NPC_SELF, ANIM_Sentinel_Anim08)
    Wait(10)
    Call(SetPlayerAnimation, ANIM_MarioW2_Flail)
    Wait(10)
    Call(func_80045838, NPC_SELF, SOUND_LRAW_SENTINEL_ALARM | SOUND_ID_TRIGGER_CHANGE_SOUND, SOUND_SPACE_DEFAULT)
    Thread
        Loop(100)
