...
#if VERSION_PAL
MSG_BIN D_PAL_80271B10[] = { 0x71, 0x71, 0x78, 0x71 };
MSG_BIN D_PAL_80271B14[] = { 0x6A, 0x6A, 0x72, 0x6A };
MSG_BIN D_PAL_80271B18[] = { 0x10, 0x10, 0x0F, 0x10 };
MSG_BIN D_PAL_80271B1C[] = { 0x3D, 0x3D, 0x3C, 0x3D };
MSG_BIN D_PAL_80271B20[] = { 0x43, 0x43, 0x42, 0x43 };
MSG_BIN D_PAL_80271B24[] = { 0x8F, 0x7F, 0x88, 0x7C };
MSG_BIN D_PAL_80271B28[] = { 0x9B, 0x88, 0x93, 0x84 };
MSG_BIN D_PAL_80271B2C[] = { 0x1A, 0x1F, 0x23, 0x18 };
MSG_BIN D_PAL_80271B30[] = { 0x00, 0x26, 0x36, 0x1A };
MSG_BIN D_PAL_80271B34[] = { 0x19, 0x19, 0x16, 0x12 };
MSG_BIN D_PAL_80271B38[] = { 0x0C, 0x08, 0x0B, 0x08 };
MSG_BIN D_PAL_80271B3C[] = { 0x85, 0x80, 0x80, 0x80 };
MSG_BIN D_PAL_80271B40[] = { 0x8C, 0x96, 0x96, 0x96 };
MSG_BIN D_PAL_80271B44[] = { 0x7D, 0x87, 0x87, 0x87 };
MSG_BIN D_PAL_80271B48[] = { 0x66, 0x70, 0x70, 0x70 };
MSG_BIN D_PAL_80271B4C[] = { 0x0C, 0x0C, 0x12, 0x0C };
MSG_BIN D_PAL_80271B50[] = { 0x50, 0x60, 0x52, 0x5F };
#endif

#if VERSION_IQUE
MSG_BIN gPauseMsg_17[] = { 0x8F, 0x0C, 0x75, 0x12, 0xFD };
MSG_BIN gPauseMsg_18[] = { 0x7B, 0x0E, 0x7C, 0x0E, 0xFD };
MSG_BIN gPauseMsg_19[] = { 0x77, 0x10, 0x74, 0x0D, 0xFD };
MSG_BIN gPauseMsg_1A[] = { 0x79, 0x12, 0x67, 0x09, 0xFD };
MSG_BIN gPauseMsg_32[] = { 0x64, 0x02, 0x75, 0x11, 0xFD };
MSG_BIN gPauseMsg_33[] = { 0x62, 0x05, 0x62, 0x05, 0x87, 0x06, 0x5F, 0x18, 0xFD };
MSG_BIN gPauseMsg_34[] = { 0x62, 0x05, 0x73, 0x02, 0x67, 0x11, 0x85, 0x10, 0xFD };
MSG_BIN gPauseMsg_35[] = { 0x7D, 0x0C, 0x85, 0x12, 0x85, 0x05, 0x79, 0x02, 0xFD };
MSG_BIN gPauseMsg_36[] = { 0x28, 0x30, 0xFD };
MSG_BIN gPauseMsg_37[] = { 0x26, 0x30, 0xFD };
MSG_BIN gPauseMsg_38[] = { 0x22, 0x30, 0xFD };
MSG_BIN gPauseMsg_39[] = { 0x0F, 0xFD };
MSG_BIN gPauseMsg_3A[] = { 0x0E, 0xFD };
MSG_BIN gPauseMsg_3B[] = { 0x69, 0x08, 0x81, 0x07, 0xFD };
MSG_BIN gPauseMsg_3C[] = { 0x7B, 0x25, 0x60, 0x01, 0xFD };
MSG_BIN gPauseMsg_3D[] = { 0x6B, 0x02, 0x6C, 0x02, 0x7B, 0x25, 0x60, 0x01, 0xFD };
MSG_BIN gPauseMsg_3E[] = { 0x6D, 0x0A, 0x6C, 0x02, 0x7B, 0x25, 0x60, 0x01, 0xFD };
MSG_BIN gPauseMsg_3F[] = { 0x69, 0x08, 0x81, 0x07, 0xFD };
MSG_BIN gPauseMsg_40[] = { 0x68, 0x04, 0x60, 0x01, 0xFD };
MSG_BIN gPauseMsg_41[] = { 0x6B, 0x02, 0x6C, 0x02, 0x68, 0x04, 0x60, 0x01, 0xFD };
MSG_BIN gPauseMsg_42[] = { 0x6D, 0x0A, 0x6C, 0x02, 0x68, 0x04, 0x60, 0x01, 0xFD };
MSG_BIN gPauseMsg_43[] = { 0x75, 0x04, 0x76, 0x04, 0x81, 0x03, 0xFD };
MSG_BIN gPauseMsg_44[] = { 0x82, 0x07, 0x6C, 0x02, 0xFD };
MSG_BIN gPauseMsg_46[] = { 0x22, 0x30, 0xFD };
MSG_BIN gPauseMsg_47[] = { 0x69, 0x07, 0x81, 0x07, 0x7B, 0x0E, 0x7C, 0x0E, 0xFD };
MSG_BIN gPauseMsg_48[] = { 0x81, 0x07, 0x6F, 0x17, 0x7B, 0x0E, 0x7C, 0x0E, 0xFD };
MSG_BIN gPauseMsg_49[] = { 0xFD };
MSG_BIN gPauseMsg_4A[] = { 0x69, 0x08, 0x81, 0x07, 0x6C, 0x14, 0x78, 0x0D, 0xF7, 0x22, 0x30, 0xFD };
MSG_BIN gPauseMsg_4B[] = { 0x76, 0x06, 0x8B, 0x06, 0x85, 0x07, 0x82, 0x12, 0x8C, 0x04, 0x87, 0x04, 0xFD };
MSG_BIN gPauseMsg_50[] = { 0x77, 0x10, 0x74, 0x0D, 0xFD };
MSG_BIN gPauseMsg_4F[] = { 0x8C, 0x07, 0x80, 0x05, 0x77, 0x10, 0x74, 0x0D, 0xFD };
MSG_BIN gPauseMsg_53[] = { 0x28, 0x30, 0xFD };
MSG_BIN gPauseMsg_54[] = { 0x26, 0x30, 0xFD };
MSG_BIN gPauseMsg_55[] = { 0x6A, 0x11, 0x8B, 0x06, 0xFD };
MSG_BIN gPauseMsg_56[] = { 0x74, 0x08, 0x74, 0x08, 0x74, 0x08, 0xFD };
#elif VERSION_US
MSG_BIN gPauseMsg_17[] = { 0x33, 0x54, 0x41, 0x54, 0x53, 0xFD };                                                                   // Stats[End]
MSG_BIN gPauseMsg_18[] = { 0x22, 0x41, 0x44, 0x47, 0x45, 0xFD };                                                                   // Badge[End]
MSG_BIN gPauseMsg_19[] = { 0x29, 0x54, 0x45, 0x4D, 0x53, 0xFD };                                                                   // Items[End]
MSG_BIN gPauseMsg_1A[] = { 0x30, 0x41, 0x52, 0x54, 0x59, 0xFD };                                                                   // Party[End]
MSG_BIN gPauseMsg_32[] = { 0x23, 0x4F, 0x49, 0x4E, 0x53, 0xFD };                                                                   // Coins[End]
MSG_BIN gPauseMsg_33[] = { 0x33, 0x54, 0x41, 0x52, 0xF7, 0x30, 0x4F, 0x49, 0x4E, 0x54, 0x53, 0xFD };                               // Star Points[End]
MSG_BIN gPauseMsg_34[] = { 0x33, 0x54, 0x41, 0x52, 0xF7, 0x30, 0x49, 0x45, 0x43, 0x45, 0x53, 0xFD };                               // Star Pieces[End]
MSG_BIN gPauseMsg_35[] = { 0x30, 0x4C, 0x41, 0x59, 0xF7, 0x34, 0x49, 0x4D, 0x45, 0xFD };                                           // Play Time[End]
MSG_BIN gPauseMsg_36[] = { MSG_CHAR_UPPER_H, MSG_CHAR_UPPER_P, MSG_CHAR_READ_END };                                                // HP[End]
MSG_BIN gPauseMsg_37[] = { MSG_CHAR_UPPER_F, MSG_CHAR_UPPER_P, MSG_CHAR_READ_END };                                                // FP[End]
MSG_BIN gPauseMsg_38[] = { MSG_CHAR_UPPER_B, MSG_CHAR_UPPER_P, MSG_CHAR_READ_END };                                                // BP[End]
MSG_BIN gPauseMsg_39[] = { MSG_CHAR_FORWARDSLASH, MSG_CHAR_READ_END };                                                             // /[End]
MSG_BIN gPauseMsg_3A[] = { MSG_CHAR_PERIOD, MSG_CHAR_READ_END };                                                                   // .[End]
MSG_BIN gPauseMsg_3B[] = { 0x2E, 0x4F, 0x4E, 0x45, 0xFD };                                                                         // None[End]
MSG_BIN gPauseMsg_3C[] = { 0x22, 0x4F, 0x4F, 0x54, 0x53, 0xFD };                                                                   // Boots[End]
MSG_BIN gPauseMsg_3D[] = { 0x33, 0x55, 0x50, 0x45, 0x52, 0xF7, 0x22, 0x4F, 0x4F, 0x54, 0x53, 0xFD };                               // Super Boots[End]
MSG_BIN gPauseMsg_3E[] = { 0x35, 0x4C, 0x54, 0x52, 0x41, 0xF7, 0x22, 0x4F, 0x4F, 0x54, 0x53, 0xFD };                               // Ultra Boots[End]
MSG_BIN gPauseMsg_3F[] = { 0x2E, 0x4F, 0x4E, 0x45, 0xFD };                                                                         // None[End]
MSG_BIN gPauseMsg_40[] = { 0x28, 0x41, 0x4D, 0x4D, 0x45, 0x52, 0xFD };                                                             // Hammer[End]
MSG_BIN gPauseMsg_41[] = { 0x33, 0x55, 0x50, 0x45, 0x52, 0xF7, 0x28, 0x41, 0x4D, 0x4D, 0x45, 0x52, 0xFD };                         // Super Hammer[End]
MSG_BIN gPauseMsg_42[] = { 0x35, 0x4C, 0x54, 0x52, 0x41, 0xF7, 0x28, 0x41, 0x4D, 0x4D, 0x45, 0x52, 0xFD };                         // Ultra Hammer[End]
MSG_BIN gPauseMsg_43[] = { 0x2D, 0x41, 0x52, 0x49, 0x4F, 0xFD };                                                                   // Mario[End]
MSG_BIN gPauseMsg_44[] = { 0x2C, 0x45, 0x56, 0x45, 0x4C, 0xFD };                                                                   // Level[End]
MSG_BIN gPauseMsg_46[] = { MSG_CHAR_UPPER_B, MSG_CHAR_UPPER_P, MSG_CHAR_READ_END };                                                // BP[End]
MSG_BIN gPauseMsg_47[] = { 0x21, 0x4C, 0x4C, 0xF7, 0x22, 0x41, 0x44, 0x47, 0x45, 0x53, 0xFD };                                     // All Badges[End]
MSG_BIN gPauseMsg_48[] = { 0x21, 0x43, 0x54, 0x49, 0x56, 0x45, 0xFD };                                                             // Active[End]
MSG_BIN gPauseMsg_49[] = { 0x22, 0x41, 0x44, 0x47, 0x45, 0x53, 0xFD };                                                             // Badges[End]
MSG_BIN gPauseMsg_4A[] = { 0x2E, 0x4F, 0x54, 0xF7, 0x45, 0x4E, 0x4F, 0x55, 0x47, 0x48, 0xF7, 0x22, 0x30, 0xFD };                   // Not enough BP[End]
MSG_BIN gPauseMsg_4B[] = { 0x24, 0x4F, 0x4E, 0x07, 0x54, 0xF7, 0x57, 0x45, 0x41, 0x52, 0xF7, 0x4D, 0x4F, 0x52, 0x45, 0x01, 0xFD }; // Don't wear more![End]
MSG_BIN gPauseMsg_50[] = { 0x29, 0x54, 0x45, 0x4D, 0x53, 0xFD };                                                                   // Items[End]
MSG_BIN gPauseMsg_4F[] = { 0x2B, 0x45, 0x59, 0xF7, 0x29, 0x54, 0x45, 0x4D, 0x53, 0xFD };                                           // Key Items[End]
MSG_BIN gPauseMsg_53[] = { MSG_CHAR_UPPER_H, MSG_CHAR_UPPER_P, MSG_CHAR_READ_END };                                                // HP[End]
MSG_BIN gPauseMsg_54[] = { MSG_CHAR_UPPER_F, MSG_CHAR_UPPER_P, MSG_CHAR_READ_END };                                                // FP[End]
MSG_BIN gPauseMsg_55[] = { 0x21, 0x42, 0x49, 0x4C, 0x49, 0x54, 0x49, 0x45, 0x53, 0xFD };                                           // Abilities[End]
MSG_BIN gPauseMsg_56[] = { MSG_CHAR_QUESTION, MSG_CHAR_QUESTION, MSG_CHAR_QUESTION, MSG_CHAR_READ_END };                                                                               // ???[End]
#elif VERSION_PAL
