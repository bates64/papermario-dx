...
#define EFFECT_PRNG_INITIAL_SEED 0x1E6D3457

static u32 effect_prng_seed = EFFECT_PRNG_INITIAL_SEED;

static const s32 SimpleRandLUT[128] = {
...
void reset_effect_utils(void) {
    effect_prng_seed = EFFECT_PRNG_INITIAL_SEED;
}
