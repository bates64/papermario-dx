...
StaticAnimatorNode Entity_MunchlesiaEnvelop_Node8 = {
    ...
    .sibling = ENTITY_ANIM_nullptr,
    .child = ENTITY_ANIM_nullptr,
...
StaticAnimatorNode Entity_MunchlesiaEnvelop_Node1 = {
    .displayList = ENTITY_ANIM_nullptr,
    .sibling = ENTITY_ANIM_nullptr,
    .child = &Entity_MunchlesiaEnvelop_Node2,
    .vertexStartOffset = (s32)ENTITY_ANIM_nullptr,
    .vtxList = ENTITY_ANIM_nullptr,
};
