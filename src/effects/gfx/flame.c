...
Gfx D_09000800_3543B0[] = {
    ...
    gsDPLoadTextureTile(OS_K0_TO_PHYSICAL(&GeneratedFlameTexture), G_IM_FMT_I, G_IM_SIZ_8b, 32, 0, 0, 0, 31, 63, 0, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR | G_TX_CLAMP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
...
// Refresh the shared 32x64 I8 flame texture. The first pass writes a combined
// source pattern into FlameTextureGenBuffer, then the second pass writes back
// to GeneratedFlameTexture while sampling shifted copies of the previous
// GeneratedFlameTexture to create the flame's persistent smear.
Gfx D_090009E0_354590[] = {
    gsDPSetColorImage(G_IM_FMT_I, G_IM_SIZ_8b, 32, OS_K0_TO_PHYSICAL(&FlameTextureGenBuffer)),
    ...
    gsSPTextureRectangle(0, 0, 0x0080, 0x0100, G_TX_RENDERTILE, 0, 0, 0x0400, 0x0400),
    gsDPPipeSync(),
    gsDPLoadTextureTile(OS_K0_TO_PHYSICAL(&FlameTextureGenBuffer), G_IM_FMT_I, G_IM_SIZ_8b, 32, 0, 0, 0, 31, 63, 0, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR | G_TX_CLAMP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetColorImage(G_IM_FMT_I, G_IM_SIZ_8b, 32, OS_K0_TO_PHYSICAL(&GeneratedFlameTexture)),
    ...
    gsDPLoadMultiTile(OS_K0_TO_PHYSICAL(&GeneratedFlameTexture), 0x0100, 1, G_IM_FMT_I, G_IM_SIZ_8b, 32, 0, 0, 0, 31, 63, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_CLAMP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
