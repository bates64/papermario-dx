...
ActorBlueprint NAMESPACE = {
    .flags = 0,
    .type = ACTOR_TYPE_PINK_SHY_GUY,
    .level = ACTOR_LEVEL_PINK_SHY_GUY,
    .maxHP = 2,
...
EvtScript N(EVS_HandleEvent) = {
    ...
    Switch(LVar0)
        ...
        CaseEq(EVENT_SHOCK_HIT)
            ...
            Call(SetActorSpeed, ACTOR_SELF, Float(3.5))
...
EvtScript N(EVS_Attack_Vault) = {
    ...
    Call(SetActorSounds, ACTOR_SELF, ACTOR_SOUND_WALK_INCREMENT, 10, 0)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_SHYGUY_Anim04)
    Call(SetActorSpeed, ACTOR_SELF, Float(2.5))
    Sub(LVar0, 40)
    Call(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    Call(RunToGoal, ACTOR_SELF, 0, FALSE)
    Call(EnemyTestTarget, ACTOR_SELF, LVar0, 0, 0, 1, BS_FLAGS1_INCLUDE_POWER_UPS)
...
EvtScript N(EVS_TakeTurn) = {
    ...
    Switch(LVar1)
        CaseLt(60) // 60% chance
            Set(LVar0, AVAL_AttackTackle)
        CaseDefault // 40% chance
            Set(LVar0, AVAL_AttackVault)
    EndSwitch
    //Set(LVar0, AVAL_AttackVault) // Set Attack
    Switch(LVar0)
        CaseEq(AVAL_AttackTackle)
