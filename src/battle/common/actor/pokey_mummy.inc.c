...
s32 N(FourPartAnims)[] = {
    ...
    STATUS_KEY_UNIMPLEMENTED,      ANIM_Pokey_Mummy_Dizzy4,
    STATUS_END,
};
...
s32 N(ThreePartAnims)[] = {
    ...
    STATUS_KEY_UNIMPLEMENTED,      ANIM_Pokey_Mummy_Dizzy3,
    STATUS_END,
};
...
s32 N(TwoPartAnims)[] = {
    ...
    STATUS_KEY_UNIMPLEMENTED,      ANIM_Pokey_Mummy_Dizzy2,
    STATUS_END,
};
...
s32 N(OnePartAnims)[] = {
    ...
    STATUS_KEY_UNIMPLEMENTED,      ANIM_Pokey_Mummy_Dizzy1,
    STATUS_END,
};
