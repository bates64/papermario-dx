...
s32 N(FlyingAnims)[] = {
    ...
    STATUS_KEY_UNIMPLEMENTED, ANIM_ParaTroopa_Dark_Stunned,
    STATUS_END,
};
...
s32 N(KoopaAnims)[] = {
    ...
    STATUS_KEY_UNIMPLEMENTED, ANIM_KoopaTroopa_Dark_Stunned,
    STATUS_END,
};
...
s32 N(ToppledAnims)[] = {
    ...
    STATUS_KEY_UNIMPLEMENTED, ANIM_KoopaTroopa_Dark_ToppleStunned,
    STATUS_END,
};
