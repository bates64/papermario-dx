...
EvtScript N(shellToss) = {
    ...
    Loop(50 * DT)
        ...
        Switch(LVar9)
            ...
            CaseEq(20 * DT)
                ...
                PlayEffect(EFFECT_SMOKE_IMPACT, 1, LVar4, LVar5, LVar6, 32, 4, 0, 10)
            CaseLt(30 * DT)
    ...
    IfEq(LVar0, HIT_RESULT_MISS)
        ...
        Wait(5)
        Call(GetActorPos, ACTOR_PARTNER, LVar4, LVar5, LVar6)
        PlayEffect(EFFECT_SMOKE_IMPACT, 1, LVar4, LVar5, LVar6, 16, 4, 0, 10)
        Loop(5)
            Add(LVar0, 12)
            Call(SetActorRotation, ACTOR_PARTNER, 0, 0, LVar0)
            Wait(1)
...
EvtScript N(fireShell) = {
    ...
    Loop(LVarD)
        ...
        Switch(LVarD)
            CaseEq(10 * DT)
                Call(GetActorPos, ACTOR_PARTNER, LVar3, LVar4, LVar5)
                PlayEffect(EFFECT_SMOKE_IMPACT, 1, LVar3, LVar4, LVar5, 32, 4, 0, 10)
            CaseEq(20 * DT)
                Call(GetActorPos, ACTOR_PARTNER, LVar3, LVar4, LVar5)
                PlayEffect(EFFECT_SMOKE_IMPACT, 1, LVar3, LVar4, LVar5, 32, 4, 0, 10)
            CaseEq(40 * DT)
