...
s32 N(DefaultAnims)[] = {
    ...
    STATUS_KEY_POISON,    ANIM_LargePiranha_Frost_Idle,
    STATUS_KEY_STOP,      ANIM_LargePiranha_Frost_Still,
    STATUS_KEY_STATIC,    ANIM_LargePiranha_Frost_Still,
    STATUS_KEY_PARALYZE,  ANIM_LargePiranha_Frost_Still,
    STATUS_KEY_PARALYZE,  ANIM_LargePiranha_Frost_Still,
    STATUS_KEY_DIZZY,     ANIM_LargePiranha_Frost_Dizzy,
    STATUS_END,
};
...
EvtScript N(EVS_ReturnHome) = {
    ...
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_LargePiranha_Frost_Idle)
...
EvtScript N(EVS_HandleEvent) = {
    ...
    Switch(LVar0)
        ...
        CaseEq(EVENT_BURN_HIT)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_LargePiranha_Frost_BurnHurt)
            SetConst(LVar2, ANIM_LargePiranha_Frost_BurnStill)
        ...
        CaseEq(EVENT_BURN_DEATH)
            ...
            ExecWait(EVS_Enemy_BurnHit)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_LargePiranha_Frost_BurnStill)
        ...
        CaseOrEq(EVENT_AIR_LIFT_FAILED)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_LargePiranha_Frost_Idle)
        ...
        CaseEq(EVENT_SCARE_AWAY)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_LargePiranha_Frost_Run)
            SetConst(LVar2, ANIM_LargePiranha_Frost_Hurt)
...
EvtScript N(EVS_Attack_Bite) = {
    ...
    Call(GetBattlePhase, LVar0)
    IfEq(LVar0, PHASE_FIRST_STRIKE)
        Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_LargePiranha_Frost_Burrow)
        ...
        Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_LargePiranha_Frost_Emerge)
        Wait(8)
    Else
    ...
    Switch(LVarA)
        ...
        CaseOrEq(HIT_RESULT_LUCKY)
            Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_LargePiranha_Frost_Windup)
            Wait(10)
            Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_LargePiranha_Frost_Bite)
            Wait(6)
            Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_LargePiranha_Frost_PostBite)
...
EvtScript N(EVS_Attack_FrostBreath) = {
    ...
    Call(RunToGoal, ACTOR_SELF, 0, false)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_LargePiranha_Frost_Idle)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_LargePiranha_Frost_FrostBreathStart)
    Wait(11)
    ...
    Switch(LVarA)
        ...
        CaseOrEq(HIT_RESULT_LUCKY)
            Wait(10)
            Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_LargePiranha_Frost_FrostBreathEnd)
            IfEq(LVarA, HIT_RESULT_LUCKY)
                Call(EnemyTestTarget, ACTOR_SELF, LVar0, DAMAGE_TYPE_TRIGGER_LUCKY, 0, 0, 0)
            EndIf
            Wait(14)
