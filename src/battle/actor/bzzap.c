...
s32 N(DefaultAnims)[] = {
    ...
    STATUS_KEY_POISON,    ANIM_Bzzap_Idle,
    STATUS_KEY_STOP,      ANIM_Bzzap_Still,
    STATUS_KEY_STATIC,    ANIM_Bzzap_Idle,
    STATUS_KEY_PARALYZE,  ANIM_Bzzap_Still,
    STATUS_KEY_DIZZY,     ANIM_Bzzap_Dizzy,
    STATUS_KEY_UNUSED,    ANIM_Bzzap_Dizzy,
    STATUS_END,
};
...
EvtScript N(EVS_HandleEvent) = {
    ...
    Switch(LVar0)
        ...
        CaseEq(EVENT_BURN_HIT)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Bzzap_BurnHurt)
            SetConst(LVar2, ANIM_Bzzap_BurnStill)
        ...
        CaseEq(EVENT_BURN_DEATH)
            ...
            ExecWait(EVS_Enemy_BurnHit)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Bzzap_BurnStill)
        ...
        CaseEq(EVENT_SPIN_SMASH_DEATH)
            ...
            ExecWait(EVS_Enemy_SpinSmashHit)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Bzzap_HurtStill)
            ExecWait(EVS_Enemy_Death)
            Return
        ...
        CaseOrEq(EVENT_AIR_LIFT_FAILED)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Bzzap_Idle)
        ...
        CaseEq(EVENT_SCARE_AWAY)
            ...
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Bzzap_FlyFast)
            SetConst(LVar2, ANIM_Bzzap_Hurt)
...
EvtScript N(EVS_Attack_Sting) = {
    ...
    Switch(LVar0)
        ...
        CaseOrEq(HIT_RESULT_LUCKY)
            ...
            Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Bzzap_Sting)
            Wait(10)
...
EvtScript N(EVS_SummonSwarmPart) = {
    ...
    Call(SetAnimation, ACTOR_SELF, LVar9, ANIM_Bzzap_FlyFast)
    Call(GetActorPos, ACTOR_SELF, LVarA, LVarB, LVarC)
    Add(LVarB, 50)
    Sub(LVarC, 30)
...
EvtScript N(EVS_Attack_CallSwarm) = {
    ...
    Call(SetActorYaw, ACTOR_SELF, 180)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Bzzap_Threaten)
    Wait(40)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Bzzap_Idle)
    Call(SetActorYaw, ACTOR_SELF, 0)
    ...
    Switch(LVar0)
        ...
        CaseOrEq(HIT_RESULT_LUCKY)
            ...
            Thread
                ...
                Call(SetAnimation, ACTOR_SELF, PRT_SWARM_1, ANIM_Bzzap_Sting)
                Call(SetGoalToTarget, ACTOR_SELF)
                ...
                Call(SetAnimation, ACTOR_SELF, PRT_SWARM_1, ANIM_Bzzap_FlyFast)
            ...
            Thread
                ...
                Call(SetAnimation, ACTOR_SELF, PRT_SWARM_2, ANIM_Bzzap_Sting)
                Call(SetGoalToTarget, ACTOR_SELF)
                Call(AddGoalPos, ACTOR_SELF, -30, -20, 1)
                Call(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
                ...
                Call(SetAnimation, ACTOR_SELF, PRT_SWARM_2, ANIM_Bzzap_FlyFast)
            ...
            Thread
                ...
                Call(SetAnimation, ACTOR_SELF, PRT_SWARM_3, ANIM_Bzzap_Sting)
                Call(SetGoalToTarget, ACTOR_SELF)
                Call(AddGoalPos, ACTOR_SELF, -30, -20, 1)
                Call(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
                ...
                Call(SetAnimation, ACTOR_SELF, PRT_SWARM_3, ANIM_Bzzap_FlyFast)
            ...
            Thread
                ...
                Call(SetAnimation, ACTOR_SELF, PRT_SWARM_4, ANIM_Bzzap_Sting)
                Call(SetGoalToTarget, ACTOR_SELF)
                Call(AddGoalPos, ACTOR_SELF, -30, -20, 1)
                Call(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
                ...
                Call(SetAnimation, ACTOR_SELF, PRT_SWARM_4, ANIM_Bzzap_FlyFast)
            ...
            Thread
                ...
                Call(SetAnimation, ACTOR_SELF, PRT_SWARM_5, ANIM_Bzzap_Sting)
                Call(SetGoalToTarget, ACTOR_SELF)
                Call(AddGoalPos, ACTOR_SELF, -30, -20, 1)
                Call(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
                ...
                Call(SetAnimation, ACTOR_SELF, PRT_SWARM_5, ANIM_Bzzap_FlyFast)
