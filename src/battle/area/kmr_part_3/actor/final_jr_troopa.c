...
EvtScript N(EVS_TransformFX) = {
    ...
    Call(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    Add(LVar1, 15)
    PlayEffect(EFFECT_ENERGY_ORB_WAVE, FX_ENERGY_ORB_WAVE_PALE_WAVE, LVar0, LVar1, LVar2, 1, 40)
    PlayEffect(EFFECT_WALKING_DUST, 0, LVar0, LVar1, LVar2, -4, 0)
    PlayEffect(EFFECT_WALKING_DUST, 0, LVar0, LVar1, LVar2, -4, 4)
    PlayEffect(EFFECT_WALKING_DUST, 0, LVar0, LVar1, LVar2, 4, 0)
    PlayEffect(EFFECT_WALKING_DUST, 0, LVar0, LVar1, LVar2, 4, 4)
    Return
    End
...
EvtScript N(EVS_Attack_MagicSpell) = {
    ...
    Add(LVar0, LVar3)
    Add(LVar1, LVar4)
    PlayEffect(EFFECT_GATHER_ENERGY_PINK, 0, LVar0, LVar1, LVar2, LVar5, 30)
    Wait(30)
    ...
    Switch(LVarA)
        CaseEq(HIT_RESULT_MISS)
            ...
            Add(LVar0, LVar6)
            Add(LVar1, LVar7)
            PlayEffect(EFFECT_SHAPE_SPELL, 0, LVar0, LVar1, LVar2, LVar3, LVar4, LVar5, 30)
            Wait(35)
            Call(EnableIdleScript, ACTOR_SELF, IDLE_SCRIPT_ENABLE)
            Call(UseIdleAnimation, ACTOR_SELF, true)
            Return
    ...
    Add(LVar0, LVar6)
    Add(LVar1, LVar7)
    PlayEffect(EFFECT_SHAPE_SPELL, 0, LVar0, LVar1, LVar2, LVar3, LVar4, LVar5, 15)
    Wait(15)
...
EvtScript N(EVS_Attack_LightningBolt) = {
    ...
    Switch(LVarA)
        CaseEq(HIT_RESULT_MISS)
            ...
            PlayEffect(EFFECT_LIGHTNING_BOLT, 0, LVar0, LVar1, LVar2, LVar3, LVar4, LVar5, Float(1.0), 18)
            Wait(20)
        CaseEq(HIT_RESULT_LUCKY)
            Call(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            Call(RandInt, 40, LVar1)
            ...
            PlayEffect(EFFECT_LIGHTNING_BOLT, 0, LVar0, LVar1, LVar2, LVar3, 0, LVar5, Float(1.0), 18)
            Thread
                Wait(10)
                Call(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
                Add(LVar1, 12)
...
EvtScript N(EVS_Move_HealSelf) = {
    ...
    Call(GetActorPos, ACTOR_SELF, LVar1, LVar2, LVar3)
    Add(LVar2, 50)
    PlayEffect(EFFECT_SPARKLES, 1, LVar1, LVar2, LVar3, 10)
    PlayEffect(EFFECT_RECOVER, 2, LVar1, LVar2, LVar3, 0)
    Wait(30)
    Call(SetAnimation, ACTOR_SELF, PRT_MAGE, ANIM_MageJrTroopa_Idle)
    Wait(10)
