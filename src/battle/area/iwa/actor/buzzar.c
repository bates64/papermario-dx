...
s32 N(DefaultAnims)[] = {
    STATUS_KEY_NORMAL,    ANIM_Buzzar_Idle,
    STATUS_KEY_STONE,     ANIM_Buzzar_Still,
    STATUS_KEY_SLEEP,     ANIM_Buzzar_Sleep,
    STATUS_KEY_STOP,      ANIM_Buzzar_Still,
    STATUS_KEY_STATIC,    ANIM_Buzzar_Dizzy,
    STATUS_KEY_PARALYZE,  ANIM_Buzzar_Dizzy,
    STATUS_KEY_DIZZY,     ANIM_Buzzar_Dizzy,
    STATUS_KEY_SHRINK,    ANIM_Buzzar_Idle,
    STATUS_END,
};

s32 N(FeatherAnims)[] = {
    STATUS_KEY_NORMAL,    ANIM_Buzzar_FeatherStill,
    STATUS_END,
};
...
EvtScript N(EVS_HandleEvent) = {
    ...
    Switch(LVar0)
        CaseEq(EVENT_HIT_COMBO)
            ...
            SetConst(LVar1, ANIM_Buzzar_Hurt)
        ...
        CaseOrEq(EVENT_AIR_LIFT_FAILED)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Buzzar_Idle)
        ...
        CaseEq(HIT_RESULT_MISS)
            ...
            Switch(LVarA)
                CaseEq(HIT_RESULT_MISS)
                    Call(SetTargetActor, ACTOR_SELF, ACTOR_PLAYER)
                    Wait(8)
                    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Buzzar_GatherWind)
                    Wait(15)
                    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Buzzar_ReleaseWind)
                    Wait(6)
                ...
                CaseDefault
                    ...
                    Call(InitActionCommand, ACV_WHIRLWIND_BUZZAR)
                    ...
                    Call(StartActionCommand, 0, 88 * DT, AC_DIFFICULTY_3)
...
EvtScript N(EVS_Attack_FeatherFling) = {
    ...
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Buzzar_GatherFeathers)
    Wait(15)
    Call(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    Add(LVar0, 24)
    Add(LVar1, 24)
    ...
    Wait(10)
    Call(SetAnimation, ACTOR_SELF, PRT_FEATHER_1, ANIM_Buzzar_FeatherStill)
    Call(SetAnimation, ACTOR_SELF, PRT_FEATHER_2, ANIM_Buzzar_FeatherStill)
    Call(SetAnimation, ACTOR_SELF, PRT_FEATHER_3, ANIM_Buzzar_FeatherStill)
    ...
    Switch(LVar0)
        ...
        CaseOrEq(HIT_RESULT_LUCKY)
            ...
            Thread
                ...
                Call(SetAnimation, ACTOR_SELF, PRT_FEATHER_2, ANIM_Buzzar_FeatherFly)
            EndThread
            Thread
                Call(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
                Call(RandInt, 10, LVar3)
                ...
                Call(SetAnimation, ACTOR_SELF, PRT_FEATHER_3, ANIM_Buzzar_FeatherFly)
            EndThread
            Call(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            Sub(LVar0, 30)
            Call(FlyPartTo, ACTOR_SELF, PRT_FEATHER_1, LVar0, 5, LVar2, 9, 0, EASING_LINEAR)
            Call(SetAnimation, ACTOR_SELF, PRT_FEATHER_1, ANIM_Buzzar_FeatherFly)
            Thread
                Wait(10)
                Call(SetAnimation, ACTOR_SELF, PRT_FEATHER_1, ANIM_Buzzar_FeatherStill)
                Call(SetAnimation, ACTOR_SELF, PRT_FEATHER_2, ANIM_Buzzar_FeatherStill)
...
EvtScript N(EVS_Attack_GrappleDrop) = {
    ...
    Wait(10)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Buzzar_Lift)
    Call(UseBattleCamPreset, BTL_CAM_ENEMY_DIVE)
    Call(SetBattleCamDist, 240)
    Call(SetBattleCamOffsetY, -10)
    Call(BattleCamTargetActor, ACTOR_SELF)
    ...
    Call(SetBattleFlagBits, BS_FLAGS1_4000, false)
    Call(ShowActionHud, true)
    Call(StartActionCommand, 0, 60 * DT, 30, AC_DIFFICULTY_3)
