...
EvtScript N(EVS_OnHit) = {
    ...
    IfEq(LVarA, true)
        ...
        ExecGetID(LVar0, N(EVS_RemoveClone))
        Label(1)
...
EvtScript N(EVS_HandleEvent) = {
    ...
    Switch(LVar0)
        ...
        CaseEq(EVENT_RECEIVE_BUFF)
            Call(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            Add(LVar1, 20)
            PlayEffect(EFFECT_SPARKLES, 0, LVar0, LVar1, LVar2, 20)
        CaseDefault
    EndSwitch
    Call(GetActorVar, ACTOR_KING, AVAR_Flags, LVar0)
...
EvtScript N(EVS_Attack_IcyBreath) = {
    ...
    Else
        ...
        Add(LVar1, 8)
        Add(LVar2, -2)
        PlayEffect(EFFECT_SPARKLES, 0, LVar0, LVar1, LVar2, 8)
    EndIf
    Wait(30)
    Call(UseBattleCamPreset, BTL_CAM_DEFAULT)
    ...
    Switch(LVar0)
        ...
        CaseOrEq(HIT_RESULT_LUCKY)
            ...
            IfNotFlag(LVar0, STATUS_FLAG_SHRINK)
                ...
                Add(LVar0, -15)
                Add(LVar1, 20)
                PlayEffect(EFFECT_HUFF_PUFF_BREATH, 0, LVar0, LVar1, LVar2, Float(180.0), Float(2.0), Float(0.5), 30)
...
EvtScript N(EVS_Attack_IceBolt) = {
        ...
        CaseOrEq(HIT_RESULT_LUCKY)
            ...
            Thread
                ...
                Loop(10)
                    ...
                    Add(LVar1, LVar4)
                    Add(LVar2, LVar5)
                    PlayEffect(EFFECT_MISC_PARTICLES, 1, LVar0, LVar1, LVar2, 20, -20, Float(1.0), 5, 30)
                    Wait(1)
                EndLoop
            EndThread
            Wait(3)
            PlayEffect(EFFECT_LIGHTNING_BOLT, 0, LVar0, LVar1, LVar2, LVar3, LVar4, LVar5, Float(1.0), 20)
    ...
    Switch(LVar0)
        ...
        CaseOrEq(HIT_RESULT_NO_DAMAGE)
            ...
            PlayEffect(EFFECT_COLD_BREATH, 0, LVar0, LVar1, LVar2, Float(2.0), 30)
...
EvtScript N(EVS_Move_MakeClones) = {
    ...
    IfFlag(LVar0, AVAL_Flag_HadLowHP)
        ...
        Call(GetActorVar, ACTOR_SELF, AVAR_Clone2_ID, LVar0)
        Call(SetActorFlagBits, LVar0, ACTOR_FLAG_FLYING, true)
        ExecGetID(LVar0, N(EVS_UpdateHovering))
...
EvtScript N(EVS_Attack_CloneBreath) = {
    ...
    Switch(LVar0)
        ...
        CaseOrEq(HIT_RESULT_LUCKY)
            ...
            IfNotFlag(LVar9, STATUS_FLAG_SHRINK)
                ...
                Add(LVar0, -15)
                Add(LVar1, 20)
                PlayEffect(EFFECT_HUFF_PUFF_BREATH, 0, LVar0, LVar1, LVar2, LVar3, Float(2.0), Float(1.0), 30)
                Call(N(SetBreathColors), LVarF)
                Call(GetActorPos, LVarA, LVar0, LVar1, LVar2)
                Add(LVar0, -15)
                Add(LVar1, 20)
            ...
            Else
                ...
                Add(LVar0, -6)
                Add(LVar1, 8)
                PlayEffect(EFFECT_HUFF_PUFF_BREATH, 0, LVar0, LVar1, LVar2, LVar3, Float(2.0), Float(0.4), 30)
                Call(N(SetBreathColors), LVarF)
                Call(GetActorPos, LVarA, LVar0, LVar1, LVar2)
                Add(LVar0, -6)
                Add(LVar1, 8)
    ...
    IfNotFlag(LVar9, STATUS_FLAG_SHRINK)
        ...
        Add(LVar0, -15)
        Add(LVar1, 20)
        PlayEffect(EFFECT_HUFF_PUFF_BREATH, 0, LVar0, LVar1, LVar2, LVar3, Float(2.0), Float(1.0), 60)
        Call(N(SetBreathColors), LVarF)
        Call(GetActorPos, LVarA, LVar0, LVar1, LVar2)
        Add(LVar0, -15)
        Add(LVar1, 20)
...
EvtScript N(EVS_RemoveBit) = {
    ...
    Thread
        ...
        Loop(10)
            ...
            Add(LVar4, LVar1)
            Add(LVar5, LVar2)
            PlayEffect(EFFECT_MISC_PARTICLES, 1, LVar3, LVar4, LVar5, 20, -20, Float(1.0), 5, 30)
            Wait(1)
        EndLoop
    EndThread
...
EvtScript N(EVS_Attack_SpitBits) = {
    ...
    IfEq(LVar1, true)
        ...
        ExecGetID(LVarA, N(EVS_InhaleBit))
    EndIf
    Call(GetActorVar, ACTOR_SELF, AVAR_King_SphereBitID, LVar0)
    Call(ActorExists, LVar0, LVar1)
    IfEq(LVar1, true)
    ...
    Switch(LVar0)
        ...
        CaseOrEq(HIT_RESULT_LUCKY)
            ...
            IfEq(LVar1, true)
                Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_CrystalKing_ExhaleLoop)
                ExecGetID(LVarA, N(EVS_RemoveBit))
                Wait(4)
                Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_CrystalKing_PostExhale)
                Wait(6)
            EndIf
    ...
    IfEq(LVar1, true)
        Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_CrystalKing_ExhaleLoop)
        ExecGetID(LVarA, N(EVS_SpitSingleBit))
        Wait(4)
        Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_CrystalKing_PostExhale)
        Wait(6)
    EndIf
