...
s32 N(FourStackAnims)[] = {
    ...
    STATUS_KEY_DIZZY,     ANIM_ShyStackGuy_Anim0C,
    STATUS_KEY_UNIMPLEMENTED,      ANIM_ShyStackGuy_Anim00,
    STATUS_END,
};
...
s32 N(ThreeStackAnims)[] = {
    ...
    STATUS_KEY_DIZZY,     ANIM_ShyStackGuy_Anim0D,
    STATUS_KEY_UNIMPLEMENTED,      ANIM_ShyStackGuy_Anim01,
    STATUS_END,
};
...
s32 N(TwoStackAnims)[] = {
    ...
    STATUS_KEY_DIZZY,     ANIM_ShyStackGuy_Anim0E,
    STATUS_KEY_UNIMPLEMENTED,      ANIM_ShyStackGuy_Anim02,
    STATUS_END,
};
...
s32 N(OneStackAnims)[] = {
    ...
    STATUS_KEY_DIZZY,     ANIM_ShyStackGuy_Anim0F,
    STATUS_KEY_UNIMPLEMENTED,      ANIM_ShyStackGuy_Anim03,
    STATUS_END,
};
