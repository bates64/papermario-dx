            ...
            IfNotFlag(LVar0, BS_FLAGS1_ATK_BLOCKED)
                ...
                IfNotFlag(LVar0, STATUS_FLAG_STONE)
                    Thread
                        ...
                        Add(LVar1, 10)
                        Wait(55)
                        PlayEffect(EFFECT_CLOUD_PUFF, LVar0, LVar1, LVar2, 0)
                    EndThread
                EndIf
            EndIf
...
EvtScript N(EVS_Move_HealOrSlam) = {
    ...
    PlayEffect(EFFECT_SPARKLES, 0, LVar0, LVar1, LVar2, LVar3)
    Add(LVar0, 20)
    PlayEffect(EFFECT_RECOVER, 0, LVar0, LVar1, LVar2, LVarA)
...
EvtScript N(EVS_Move_HurricaneBreath) = {
    ...
    Switch(LVar0)
        ...
        CaseOrEq(HIT_RESULT_LUCKY)
            ...
            Loop(10)
                ...
                PlayEffect(EFFECT_MOVING_CLOUD, 0, 200, LVar3, 5, -200, LVar4, 5, LVar5, LVar4)
    ...
    IfNotFlag(LVar0, STATUS_FLAG_STONE)
        ...
        Call(InitActionCommand, ACV_WHIRLWIND_HUFF)
        Call(SetupMashMeter, 5, 20, 40, 60, 80, 100)
        Wait(10)
        Call(SetBattleFlagBits, BS_FLAGS1_4000, false)
        Call(StartActionCommand, 0, 200 * DT, AC_DIFFICULTY_3)
        Thread
            Call(GetActorVar, ACTOR_SELF, AVAR_ScaleX, LVar2)
            Set(LVar3, LVar2)
            Sub(LVar3, 25)
...
EvtScript N(EVS_Attack_DirectLightning) = {
    ...
    Switch(LVar0)
        CaseEq(HIT_RESULT_LUCKY)
            ...
            Sub(LVarD, 100)
            PlayEffect(EFFECT_LIGHTNING_BOLT, 0, LVarA, LVarB, LVarC, LVarD, 0, LVarF, Float(1.5), 20)
            Call(EnemyTestTarget, ACTOR_SELF, LVar0, DAMAGE_TYPE_TRIGGER_LUCKY, 0, 0, 0)
            Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_HuffNPuff_IdleSadBody)
            Call(SetAnimation, ACTOR_SELF, PRT_FACE, ANIM_HuffNPuff_IdleSadFace)
            Call(SetAnimation, ACTOR_SELF, PRT_ARMS, ANIM_HuffNPuff_IdleSadArms)
        ...
        CaseEq(HIT_RESULT_MISS)
            ...
            Thread
                ...
                MulF(LVar9, 3)
                AddF(LVar9, LVar0)
                PlayEffect(EFFECT_LIGHTNING_BOLT, 0, LVar9, LVar1, LVar2, LVar3, LVar4, LVar5, Float(1.2), 10)
                Wait(3)
                SetF(LVar9, LVar8)
                MulF(LVar9, 1)
                AddF(LVar9, LVar0)
...
EvtScript N(EVS_Attack_GroupSlam) = {
    ...
    Call(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    PlayEffect(EFFECT_SHOCKWAVE, 3, LVar0, 0, LVar2)
    Thread
        PlayEffect(EFFECT_SMOKE_IMPACT, 1, LVar1, LVar4, LVar3, 60, 8, 0, 30)
        Wait(2)
        PlayEffect(EFFECT_SMOKE_IMPACT, 1, LVar1, LVar4, LVar3, 60, 8, 33, 30)
        Wait(2)
        PlayEffect(EFFECT_SMOKE_IMPACT, 1, LVar1, LVar4, LVar3, 60, 8, 66, 30)
    EndThread
    Thread
        Call(ShakeCam, CAM_BATTLE, 0, 20, Float(1.0))
    EndThread
