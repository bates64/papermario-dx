...
class Opcode(IntEnum):
    ...
    EVT_OP_BUF_READ = (0x40, 1, MAX_ARGC)
    EVT_OP_BUF_PEEK = (0x41, 2)
    EVT_OP_USE_FBUF = (0x42, 1)
    EVT_OP_FBUF_READ = (0x43, 1, MAX_ARGC)
    EVT_OP_FBUF_PEEK = (0x44, 2)
    EVT_OP_USE_ARRAY = (0x45, 1)
    EVT_OP_USE_FLAGS = (0x46, 1)
    EVT_OP_MALLOC_ARRAY = (0x47, 2)
    EVT_OP_BITWISE_AND = (0x48, 2)
    EVT_OP_BITWISE_AND_CONST = (0x49, 2)
    EVT_OP_BITWISE_OR = (0x4A, 2)
    EVT_OP_BITWISE_OR_CONST = (0x4B, 2)
    EVT_OP_CALL = (0x4C, 1, MAX_ARGC)
    EVT_OP_EXEC = (0x4D, 1, MAX_ARGC)
    EVT_OP_EXEC_GET_ID = (0x4E, 2, MAX_ARGC)
    EVT_OP_EXEC_WAIT = (0x4F, 1, MAX_ARGC)
    EVT_OP_BIND_TRIGGER = (0x50, 5)
    EVT_OP_UNBIND = (0x51, 0)
    EVT_OP_KILL_SCRIPT = (0x52, 1)
    EVT_OP_JUMP = (0x53, 1)
    EVT_OP_SET_PRIORITY = (0x54, 1)
    EVT_OP_SET_TIMESCALE = (0x55, 1)
    EVT_OP_SET_GROUP = (0x56, 1)
    EVT_OP_BIND_ITEM_PROMPT = (0x57, 6)
    EVT_OP_SUSPEND_GROUP = (0x58, 1)
    EVT_OP_RESUME_GROUP = (0x59, 1)
    EVT_OP_SUSPEND_OTHERS = (0x5A, 1)
    EVT_OP_RESUME_OTHERS = (0x5B, 1)
    EVT_OP_SUSPEND_SCRIPT = (0x5C, 1)
    EVT_OP_RESUME_SCRIPT = (0x5D, 1)
    EVT_OP_IS_SCRIPT_RUNNING = (0x5E, 2)
    EVT_OP_THREAD = (0x5F, 0)
    EVT_OP_END_THREAD = (0x60, 0)
    EVT_OP_CHILD_THREAD = (0x61, 0)
    EVT_OP_END_CHILD_THREAD = (0x62, 0)
    EVT_OP_AWAIT_CHILDREN = (0x63, 0)
    EVT_OP_AWAIT_SCRIPT = (0x64, 1)
    EVT_OP_DEBUG_PRINT_VAR = (0x65, 1)
    EVT_OP_DEBUG_BREAKPOINT = (0x66, 1)
    EVT_OP_EXPECT_ARGS = (0x67, 1)
    EVT_OP_FINALLY = (0x68, 0)
    EVT_OP_EVAL = (0x69, 2, 2 + MAX_EVAL_ARGS)
    EVT_OP_EVALF = (0x6A, 2, 2 + MAX_EVAL_ARGS)
    EVT_OP_INVOKE = (0x6B, 1, 1 + MAX_EVAL_ARGS)
    EVT_OP_INVOKEF = (0x6C, 1, 1 + MAX_EVAL_ARGS)
    EVT_OP_IF_EVAL = (0x6D, 1, 1 + MAX_EVAL_ARGS)
    EVT_OP_IF_NOT_EVAL = (0x6E, 1, 1 + MAX_EVAL_ARGS)
    EVT_OP_IF_EVALF = (0x6F, 1, 1 + MAX_EVAL_ARGS)
    EVT_OP_IF_NOT_EVALF = (0x70, 1, 1 + MAX_EVAL_ARGS)
    EVT_OP_LERP = (0x71, 5)
    EVT_OP_END_LERP = (0x72, 0)
