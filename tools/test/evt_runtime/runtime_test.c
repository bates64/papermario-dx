...
EvtScript EVS_TestMemory = {
    MemGet(LVar0, gMemLoadU8)
    MemGet(LVar1, gMemLoadS8)
    MemGet(LVar2, gMemLoadU16)
    MemGet(LVar3, gMemLoadS16)
    MemGet(LVar4, gMemLoadU32)
    MemGet(LVar5, gMemLoadS32)
    MemGet(LVar6, gMemLoadF32)
    Call(VerifyMemLoads)

    MemSet(gMemStoreU8, 0x1AB)
    MemSet(gMemStoreS8, -100)
    MemSet(gMemStoreU16, 0x12345)
    MemSet(gMemStoreS16, -20000)
    MemSet(gMemStoreU32, (s32)0x89ABCDEF)
    MemSet(gMemStoreS32, -12345)
    SetF(LVar7, Float(-2.5))
    MemSet(gMemStoreF32, LVar7)
    Call(VerifyMemStores)

    MemGet(LVar0, gMemValues[2])
    Set(LVar1, 2)
    MemGetIndex(LVar2, gMemValues, LVar1)
    MemSetIndex(gMemValues, LVar1, -7)
    MemGetIndex(LVar3, gMemValues, LVar1)
    Call(VerifyMemIndex)
    End
};
